 ...
 *
 * Nous aurons tout d'abord le compte en banque classique représentée par 
 * la classe BankAccount.
 * Il possédera un identifiant (int), 
 * un propriétaire (string) et 
 * une balance (float).
...
echo $savingAccount01->getBalance(); // Renvoie 1007,5
